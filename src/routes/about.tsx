      ...
      <main
        ...
        <header className="flex justify-between items-center bg-indigo-700 text-white py-1 px-6 lg:px-12 lg:py-2">
          <div>
            <Link
              to="/"
              className="flex items-center gap-2 cursor-pointer tracking-wide text-sm">
          ...
          <div className="flex items-center gap-2">
            <Link
              to="/about"
              className="font-medium text-sm tracking-wide py-1 px-4 rounded-2xl transition-colors duration-300 ease-in-out hover:bg-black-500 [&.active]:bg-black-500">
              About
            </Link>
            <Link
              to="/contact"
              className="font-medium text-sm tracking-wide py-1 px-4 rounded-2xl transition-colors duration-300 ease-in-out hover:bg-black-500">
              Contact
            </Link>
