...
function NoteContent() {
  ...
  return (
    <article className="min-h-dvh w-full dark:bg-black-100">
      {/* Navbar */}
      ...
      <section className="mx-auto grid max-w-xl gap-4 px-4 pt-8" key={id}>
        ...
        <p
          className="animate-fadeIn rounded text-sm dark:text-neutral-300"
      ...
      {/* Buttons */}
      <div className="mx-auto flex max-w-xl items-center justify-end gap-2 px-4 pt-10 text-neutral-100">
        <button
          type="button"
        ...
        <button
          ...
          onClick={removeNote}
        >
          <span className="hidden text-sm font-medium md:block">Delete</span>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
