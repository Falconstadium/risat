export const AnimationLoading = () => {
  return (
    <div className="grid min-h-dvh w-full place-content-center bg-neutral-100 dark:bg-black-500">
...
export const Spinner = () => {
  return (
    <div className="grid min-h-dvh w-full place-content-center bg-neutral-100 dark:bg-black-500">
      <div className="h-20 w-20 animate-spin place-content-center rounded-full border-4 border-gray-300 border-t-blue-500" />
    </div>
  );
};

export const WideSpin = () => {
  return (
    <div className="grid min-h-dvh w-full place-content-center bg-neutral-100 dark:bg-black-500">
      <div className="relative">
        ...
        <div className="absolute inset-0 animate-pulse rounded-full bg-gradient-to-tr from-indigo-700/10 via-transparent to-indigo-700/5 blur-sm" />
      </div>
    </div>
  );
};
